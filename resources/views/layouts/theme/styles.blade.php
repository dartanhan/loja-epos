...
<link href="{{ asset('assets/fontawesome/css/brands.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/fontawesome/css/solid.css') }}" rel="stylesheet" type="text/css">
